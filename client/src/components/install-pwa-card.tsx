  ...
  return (
    <Card>
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          Add GuardTrack to your home screen for quick access
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isInstallable ? (
          <Button onClick={installApp} className="w-full" data-testid="button-install-pwa">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button variant="secondary" className="w-full" data-testid="button-install-instructions">
                <Download className="h-4 w-4 mr-2" />
                How to Install
              </Button>
            </DialogTrigger>
