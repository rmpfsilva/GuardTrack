...
- **Super Admin Interface**: Redesigned to focus on client management rather than operational data. Features include:
  ...
  - **Usage Reports Tab**: Monthly-based (previous/current month) usage reports per client showing check-ins and active guard counts, replacing operational billing and weekly reports.
